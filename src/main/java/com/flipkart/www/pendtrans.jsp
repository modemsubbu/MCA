...
</div><body background="images\001.jpg" width="778" height="1280" />
...
ResultSet rs1=st1.executeQuery();%><BR><BR><center><h2>Pending Transactions
<table align=center cellpadding="0" border=1 width="100%" cellspacing="0">
