...
<center><h3><font color="red">Your request is in process</h3> </font></center>
<center><input type="button" name=back  value="   OK  " onClick="window.location='newbankuser.jsp'"></center>
